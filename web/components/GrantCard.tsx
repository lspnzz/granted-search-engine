      ...
      <div className={styles.metaList}>
        ...
        >
          <div className={styles.metaLabelGroup}>
            <span className={styles.icon}>
              <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_165_61)">
                  <path d="M2.43529 13.9999H13.0296C14.6506 13.9999 15.4571 13.21 15.4571 11.6451V2.37C15.4571 0.805155 14.6506 0.0151367 13.0296 0.0151367H2.43529C0.81435 0.0151367 0 0.797558 0 2.37V11.6451C0 13.2175 0.81435 13.9999 2.43529 13.9999ZM2.31896 12.7769C1.6287 12.7769 1.24868 12.42 1.24868 11.7135V4.55015C1.24868 3.85128 1.6287 3.48666 2.31896 3.48666H13.1304C13.8206 3.48666 14.2084 3.85128 14.2084 4.55015V11.7135C14.2084 12.42 13.8206 12.7769 13.1304 12.7769H2.31896Z" fill="currentColor" fill-opacity="1" />
                  <path d="M11.3531 9.2293C11.9736 9.2293 12.4776 8.73555 12.4776 8.12783C12.4776 7.52013 11.9736 7.02637 11.3531 7.02637C10.7326 7.02637 10.2285 7.52013 10.2285 8.12783C10.2285 8.73555 10.7326 9.2293 11.3531 9.2293Z" fill="currentColor" fill-opacity="1" />
                  <path d="M7.732 9.2293C8.35245 9.2293 8.85658 8.73555 8.85658 8.12783C8.85658 7.52013 8.35245 7.02637 7.732 7.02637C7.1193 7.02637 6.60742 7.52013 6.60742 8.12783C6.60742 8.73555 7.1193 9.2293 7.732 9.2293Z" fill="currentColor" fill-opacity="1" />
                  <path d="M4.11872 9.2293C4.73918 9.2293 5.2433 8.73555 5.2433 8.12783C5.2433 7.52013 4.73142 7.02637 4.11872 7.02637C3.49827 7.02637 2.99414 7.52013 2.99414 8.12783C2.99414 8.73555 3.49827 9.2293 4.11872 9.2293Z" fill="currentColor" fill-opacity="1" />
                </g>
                <defs>
